      ...
      <View style={styles.contentContainer}>
        ...
        <View style={styles.formContainer}>
          ...
          <View style={styles.passwordInputContainer}>
            ...
            <TouchableOpacity
              style={styles.eyePasswordButton}
              onPress={togglePasswordVisibility1} // Call togglePasswordVisibility function when eye icon is pressed
            >
              <FontAwesomeIcon
                icon={passwordVisible1 ? faEyeSlash : faEye} // Change icon based on password visibility state
                style={styles.eyePasswordIcon}
              />
            </TouchableOpacity>
          </View>
