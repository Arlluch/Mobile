...
function VerifyFPemail({ navigation }) {
    ...
    <View style={styles.container}>
      <View style={styles.contentContainer}>
        <View style={styles.formContainer}>
          ...
          <Text style={styles.weJustSent}>{`We just sent an Email to [email]
Please enter the 6-digit code we provided to retrieve your account. If you haven't received the code, please check your spam folder`}</Text>
          {error && (
