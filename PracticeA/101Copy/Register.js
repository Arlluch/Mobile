...
function Register({ navigation }) {
  ...
  const [genderError, setGenderError] = useState(false); // Initialize gender error state
  ...
  const [items, setItems] = useState([
    { label: "Select Gender", value: null }, // Placeholder
    ...
    <ScrollView contentContainerStyle={styles.container} behavior="padding">
      <View style={styles.formContainer}>
        ...
        <DropDownPicker
          ...
          setValue={(selectedValue) => {
            ...
            if (selectedValue !== null) {
              setGender(selectedValue); // Set the selected gender
              setGenderError(false);
            }
          }}
          setItems={setItems}
        ...
        <View style={styles.passwordInputContainer}>
          ...
          <TouchableOpacity style={styles.eyePasswordButton}>
            <FontAwesomeIcon icon={faEye} style={styles.eyePasswordIcon} />
          </TouchableOpacity>
        </View>
